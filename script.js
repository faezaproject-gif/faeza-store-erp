...
function saveSupplier() {
    ...
    db.suppliers.push({
        ...
        phone:
            document.getElementById("sPhone").value.trim(),
...
function renderSuppliers() {
    ...
    el.innerHTML = db.suppliers.length
...
function renderDebts() {
    ...
    const hutangEl =
        document.getElementById("hutangTotal");

    const piutangEl =
        document.getElementById("piutangTotal");

    if (hutangEl)
        hutangEl.textContent = "Rp" + rupiah(hutang);

    if (piutangEl)
        piutangEl.textContent = "Rp" + rupiah(piutang);

    el.innerHTML = db.debts.length
